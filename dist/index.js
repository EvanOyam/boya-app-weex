...
var _weexXPicker = __webpack_require__(119);
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      isShow: false,
      showPicker: false,
      list: [{ title: '金星' }, { title: '木星' }, { title: '水星' }, { title: '火星' }, { title: '地球' }, { title: '天王星' }, { title: '海王星' }, { title: '冥王星' }, { title: '哈雷彗星' }],
      customStyles: {
        lineSpacing: '14px',
        width: '200px',
        height: '90px',
...
var _area = __webpack_require__(134);
...
var _wxcOverlay = __webpack_require__(127);
