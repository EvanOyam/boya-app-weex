...
var roomToPeriod = exports.roomToPeriod = function roomToPeriod(room) {
  switch (room) {
    case '9:00-10:00':
      return '1';
    case '10:00-11:00':
...
var periodToRoom = exports.periodToRoom = function periodToRoom(period) {
  switch (period) {
    case '1':
      return '9:00-10:00';
    case '2':
...
var _Result = __webpack_require__(23);

var _Result2 = _interopRequireDefault(_Result);

var _AdPage = __webpack_require__(36);
...
var _Booking = __webpack_require__(108);

var _Booking2 = _interopRequireDefault(_Booking);

var _Update = __webpack_require__(138);
...
var _wxcResult = __webpack_require__(26);
...
var _TopBar = __webpack_require__(2);

var _TopBar2 = _interopRequireDefault(_TopBar);

var _HeadBlock = __webpack_require__(3);
...
var _wxcMinibar = __webpack_require__(58);
...
var _wxcMask = __webpack_require__(89);
...
var _roomHandler = __webpack_require__(8);
...
exports.default = {
  ...
  methods: {
    openMask: function openMask(i) {
      ...
      stream.fetch({
        ...
        if (res.status === 401) {
          ...
          var bookingTime = (0, _roomHandler.periodToRoom)(res.data.info.period);
          var bookingDate = new Date(Number(res.data.info.reservationDate)).toLocaleDateString();
          var startTime = bookingTime.split('-')[0];
          var endTime = bookingTime.split('-')[1];
          var bookingInfo = {
    ...
    getBookingInfo: function getBookingInfo() {
      ...
      stream.fetch({
        method: 'GET',
        url: 'http://127.0.0.1:9092/getBookingInfo?username=' + _this.userInfo.username,
        type: 'json',
        headers: {
          'Content-Type': 'application/json',
          Authorization: 'Bearer ' + _this.token
    ...
    sortBookingInfo: function sortBookingInfo(property) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "wxcButtonClicked": _vm.changeUser
    }
  }), _c('wxc-button', {
    staticClass: ["sign-out-btn"],
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.maskInfo.classroom) + "琴房二维码")]), _c('wxc-cell', {
    attrs: {
      "label": "开始时间",
...
exports.default = {
  ...
  created: function created() {
    var _this = this;
    _bus2.default.$on('testlog', function (data) {
      _this.log = data;
    });
  }
}; //
...
var _wxcGridSelect = __webpack_require__(111);
...
var _weexXPicker = __webpack_require__(120);
...
exports.default = {
  ...
  methods: {
    ...
    // 预约点击事件
    wxcCellClicked: function wxcCellClicked(i) {
      var _this = this;
      modal.confirm({
        message: '确认预约当前琴房？',
        okTitle: '确认',
        ...
        if (value === '确认') {
          if (_this.userInfo.truename && _this.userInfo.phoneNum) {
            var period = (0, _roomHandler.roomToPeriod)(_this.roomList[i].time);
            var rawBody = {
            ...
            stream.fetch({
              method: 'POST',
              url: 'http://127.0.0.1:9092/roombooking',
              type: 'json',
              headers: {
                'Content-Type': 'application/json',
                Authorization: 'Bearer ' + _this.token
    ...
    getRoomList: function getRoomList(searchData) {
      ...
      stream.fetch({
        method: 'GET',
        url: 'http://127.0.0.1:9092/getroominfo?instrument=' + instrument + '&date=' + date,
        type: 'json'
      }, function (res) {
        if (!res.ok) {
          modal.toast({
          ...
          var roomData = res.data.data.roomData.map(function (item) {
            var time = (0, _roomHandler.periodToRoom)(item.period);
            var newItem = {
              room: item.roomId,
              time: time
            };
...
var _wxcPopup = __webpack_require__(124);
...
var _wxcOverlay = __webpack_require__(128);
  ...
  methods: {
    update: function update() {
      ...
      if (truename && phoneNum && code) {
        stream.fetch({
          method: 'GET',
          url: 'http://127.0.0.1:9092/getmsg?username=' + _this.userInfo.username + '&phoneNum=' + phoneNum + '&truename=' + truename + '&code=' + code,
          type: 'json',
          headers: {
            'Content-Type': 'application/json',
            Authorization: 'Bearer ' + _this.token
    ...
    onInputTruename: function onInputTruename(e) {
      this.truename = e.value;
    },
    onInputPhoneNum: function onInputPhoneNum(e) {
    ...
    getCode: function getCode() {
      if (this.phoneNum) {
        ...
        stream.fetch({
          method: 'GET',
          url: 'http://127.0.0.1:9092/sendmsg?username=' + _this.userInfo.username + '&phoneNum=' + phoneNum,
          type: 'json',
          headers: {
            'Content-Type': 'application/json',
            Authorization: 'Bearer ' + _this.token
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["update-wrapper-bottom"]
  }, [_c('div', {
    staticClass: ["input-box"]
  }, [_c('input', {
    staticClass: ["input"],
    ...
    on: {
      "wxcButtonClicked": _vm.update
    }
  })], 1)]), _c('image', {
    staticClass: ["update-logo"],
    attrs: {
      "src": _vm.logoSrc
    }
  })])
  ...
  return _c('div', {
    staticClass: ["update-wrapper-top"]
  }, [_c('text', {
    staticClass: ["update-title-zh"]
  }, [_vm._v("伯雅音乐")]), _c('text', {
    staticClass: ["update-title-en"]
  }, [_vm._v("Boya Music")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["input-icon"]
